...
namespace Akila.FPSFramework.Examples
{
    ...
    public class SettingsPresetBIRP : SettingsPreset
    {
        ...
        {
            if (value == 0) QualitySettings.antiAliasing = 0;
            if (value == 1) QualitySettings.antiAliasing = 2;
            if (value == 2) QualitySettings.antiAliasing = 4;
            if (value == 3) QualitySettings.antiAliasing = 8;
        }
